...
export const CourseView = () => {
    ...
    // const [saveCourseData, setSaveCourseData] = useState(Set([]));
    ...
    //     localStorage.setItem('saveCourses', courseData);
    // }
                    ...
                    <div className="border p-2 rounded">
                        ...
                        <div className="flex flex-col justify-between gap-2 p-2 ">
                            ...
                            <div className="flex flex-col gap-1">
                                <p className=" ~text-xs/sm"><span className="font-mono font-semibold">Description :</span>  {courseData.description}</p>
                            </div>

                            <p className=" ~text-xs/sm"><span className="font-mono font-semibold">Lecturer :</span> {courseData.lecturer}</p>
                            <p className=" ~text-xs/sm"><span className="font-mono font-semibold">Language :</span> {courseData.language}</p>
                            <p className=" ~text-xs/sm"><span className="font-mono font-semibold">Duration :</span> {courseData.duration}</p>
                            <p className=" ~text-xs/sm"><span className="font-mono font-semibold">Offer :</span> {courseData.offer}</p>
